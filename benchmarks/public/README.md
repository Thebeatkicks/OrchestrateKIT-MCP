...
- Registry fingerprint: `6d3bf1e426d555c8`
- Report fingerprint: `9243cc4755f193ab`
- Public non-beta registry: 67 components / 165 edges / 12 routes / 12 playbooks / 4 workers
...
Deterministic route scores range from 62 to 84 (average 72.6). These are graph-internal scores, not LLM quality scores. The report also exposes 3 non-validated routes, 0 untested-edge occurrences, and 3 compose-noise flags instead of hiding them.
...
| p6_email_lead_crm | 5/5 | validated | 62 | 0 | 0 | `email_lead_to_crm` | PASS |
