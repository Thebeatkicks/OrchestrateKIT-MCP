...
- Registry fingerprint: `d9b06658d1d176da`
- Report fingerprint: `6ee22fbb0a30b685`
- Public non-beta registry: 66 components / 164 edges / 12 routes / 12 playbooks / 4 workers
...
Deterministic route scores range from 61 to 84 (average 72.4). These are graph-internal scores, not LLM quality scores. The report also exposes 3 non-validated routes, 0 untested-edge occurrences, and 2 compose-noise flags instead of hiding them.
