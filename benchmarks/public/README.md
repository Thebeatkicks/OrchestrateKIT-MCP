...
- Registry fingerprint: `a59ee01fa6e99a1a`
- Report fingerprint: `394e431d161194d6`
- Public non-beta registry: 67 components / 166 edges / 12 routes / 12 playbooks / 4 workers
...
Deterministic route scores range from 62 to 84 (average 72.6). These are graph-internal scores, not LLM quality scores. The report also exposes 3 non-validated routes, 0 untested-edge occurrences, and 2 compose-noise flags instead of hiding them.
